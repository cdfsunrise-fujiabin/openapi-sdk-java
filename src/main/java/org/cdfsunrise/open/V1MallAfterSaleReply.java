...
public class V1MallAfterSaleReply {
    public static class V1MallAfterSaleReplyResponse {
    ...
    */
    public V1MallAfterSaleReplyResponse V1MallAfterSaleReply(String host, String authToken, BaseRequest body) throws Exception {
    	OkHttpHelper httpHelper = new OkHttpHelper();
    	Map<String, String> headers = new HashMap<String, String>();
    	headers.put("Authorization", authToken);
        
    	String bodyString = JSON.toJSONString(body);
        String respStr = httpHelper.Post(String.format("%s%s", host, String.format("/v1/mall/after/sale/reply")), headers, bodyString);
        
        return JSON.parseObject(respStr, V1MallAfterSaleReplyResponse.class);
    }
}
