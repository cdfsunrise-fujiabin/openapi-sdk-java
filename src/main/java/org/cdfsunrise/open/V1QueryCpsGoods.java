...
public class V1QueryCpsGoods {
    public static class V1QueryCpsGoodsResponse {
    ...
    */
    public V1QueryCpsGoodsResponse V1QueryCpsGoods(String host, String authToken, OpenDataReq body) throws Exception {
    	OkHttpHelper httpHelper = new OkHttpHelper();
    	Map<String, String> headers = new HashMap<String, String>();
    	headers.put("Authorization", authToken);
        
    	String bodyString = JSON.toJSONString(body);
        String respStr = httpHelper.Post(String.format("%s%s", host, String.format("/v1/query/cps/goods")), headers, bodyString);
        
        return JSON.parseObject(respStr, V1QueryCpsGoodsResponse.class);
    }
}
