...
public class V1UserUseSocre {
    public static class V1UserUseSocreResponse {
    ...
    */
    public V1UserUseSocreResponse V1UserUseSocre(String host, String authToken, OpenDataReq body) throws Exception {
    	OkHttpHelper httpHelper = new OkHttpHelper();
    	Map<String, String> headers = new HashMap<String, String>();
        headers.put("Authorization", authToken);
    	
    	String bodyString = JSON.toJSONString(body);
        String respStr = httpHelper.Post(String.format("%s%s", host, String.format("/v1/user/useSocre")), headers, bodyString);
        
        V1UserUseSocreResponse respEntity = new V1UserUseSocreResponse();
