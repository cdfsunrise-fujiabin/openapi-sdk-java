...
public class V1QueryGoodsCategory {
    public static class V1QueryGoodsCategoryResponse {
    ...
    */
    public V1QueryGoodsCategoryResponse V1QueryGoodsCategory(String host, String authToken, OpenDataReq body) throws Exception {
    	OkHttpHelper httpHelper = new OkHttpHelper();
    	Map<String, String> headers = new HashMap<String, String>();
    	headers.put("Authorization", authToken);
        
    	String bodyString = JSON.toJSONString(body);
        String respStr = httpHelper.Post(String.format("%s%s", host, String.format("/v1/query/goodsCategory")), headers, bodyString);
        
        return JSON.parseObject(respStr, V1QueryGoodsCategoryResponse.class);
    }
}
