...
public class V1PinganQuerycoupon {
    public static class V1PinganQuerycouponResponse {
    ...
    /*V1PinganQuerycoupon
     *Description: 【平安】查询优惠券核销状态
     * @param: body BaseRequest BaseRequest 必填项
     * @return: *V1PinganQuerycouponResponse
    */
    public V1PinganQuerycouponResponse V1PinganQuerycoupon(String host, String authToken, BaseRequest body) throws Exception {
    	OkHttpHelper httpHelper = new OkHttpHelper();
    	Map<String, String> headers = new HashMap<String, String>();
    	headers.put("Authorization", authToken);
        
    	String bodyString = JSON.toJSONString(body);
        String respStr = httpHelper.Post(String.format("%s%s", host, String.format("/v1/pingan/querycoupon")), headers, bodyString);
        
        return JSON.parseObject(respStr, V1PinganQuerycouponResponse.class);
    }
}
