...
public class V1UserQrcode {
    public static class V1UserQrcodeResponse {
    ...
    */
    public V1UserQrcodeResponse V1UserQrcode(String host, String authToken, OpenDataReq body) throws Exception {
    	OkHttpHelper httpHelper = new OkHttpHelper();
    	Map<String, String> headers = new HashMap<String, String>();
    	headers.put("Authorization", authToken);
        
    	String bodyString = JSON.toJSONString(body);
        String respStr = httpHelper.Post(String.format("%s%s", host, String.format("/v1/user/qrcode")), headers, bodyString);
        
        return JSON.parseObject(respStr, V1UserQrcodeResponse.class);
    }
}
