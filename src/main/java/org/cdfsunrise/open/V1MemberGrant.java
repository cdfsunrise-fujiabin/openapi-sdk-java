...
public class V1MemberGrant {
    public static class V1MemberGrantResponse {
    ...
    */
    public V1MemberGrantResponse V1MemberGrant(String host, String authToken, OpenDataReq body) throws Exception {
    	OkHttpHelper httpHelper = new OkHttpHelper();
    	Map<String, String> headers = new HashMap<String, String>();
    	headers.put("Authorization", authToken);
        
    	String bodyString = JSON.toJSONString(body);
        String respStr = httpHelper.Post(String.format("%s%s", host, String.format("/v1/member/grant")), headers, bodyString);
        
        return JSON.parseObject(respStr, V1MemberGrantResponse.class);
    }
}
