...
public class V1UserAccountQuery {
    public static class V1UserAccountQueryResponse {
    ...
    */
    public V1UserAccountQueryResponse V1UserAccountQuery(String host, String authToken, OpenDataReq body) throws Exception {
    	OkHttpHelper httpHelper = new OkHttpHelper();
    	Map<String, String> headers = new HashMap<String, String>();
        headers.put("Authorization", authToken);
    	
    	String bodyString = JSON.toJSONString(body);
        String respStr = httpHelper.Post(String.format("%s%s", host, String.format("/v1/user/accountQuery")), headers, bodyString);
        
        V1UserAccountQueryResponse respEntity = new V1UserAccountQueryResponse();
