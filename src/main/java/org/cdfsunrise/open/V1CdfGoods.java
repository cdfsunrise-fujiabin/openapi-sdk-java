...
public class V1CdfGoods {
    public static class V1CdfGoodsResponse {
    ...
    */
    public V1CdfGoodsResponse V1CdfGoods(String host, String authToken, OpenDataReq body) throws Exception {
    	OkHttpHelper httpHelper = new OkHttpHelper();
    	Map<String, String> headers = new HashMap<String, String>();
    	headers.put("Authorization", authToken);
        
    	String bodyString = JSON.toJSONString(body);
        String respStr = httpHelper.Post(String.format("%s%s", host, String.format("/v1/cdf/goods")), headers, bodyString);
        
        return JSON.parseObject(respStr, V1CdfGoodsResponse.class);
    }
}
