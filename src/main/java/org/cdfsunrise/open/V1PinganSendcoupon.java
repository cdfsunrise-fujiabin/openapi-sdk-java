...
public class V1PinganSendcoupon {
    public static class V1PinganSendcouponResponse {
    ...
    /*V1PinganSendcoupon
     *Description: 【平安】发放优惠券
     * @param: body BaseRequest BaseRequest 必填项
     * @return: *V1PinganSendcouponResponse
    */
    public V1PinganSendcouponResponse V1PinganSendcoupon(String host, String authToken, BaseRequest body) throws Exception {
    	OkHttpHelper httpHelper = new OkHttpHelper();
    	Map<String, String> headers = new HashMap<String, String>();
    	headers.put("Authorization", authToken);
        
    	String bodyString = JSON.toJSONString(body);
        String respStr = httpHelper.Post(String.format("%s%s", host, String.format("/v1/pingan/sendcoupon")), headers, bodyString);
        
        return JSON.parseObject(respStr, V1PinganSendcouponResponse.class);
    }
}
