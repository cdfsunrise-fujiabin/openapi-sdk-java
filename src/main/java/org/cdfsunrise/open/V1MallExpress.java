...
public class V1MallExpress {
    public static class V1MallExpressResponse {
    ...
    */
    public V1MallExpressResponse V1MallExpress(String host, String authToken, BaseRequest body) throws Exception {
    	OkHttpHelper httpHelper = new OkHttpHelper();
    	Map<String, String> headers = new HashMap<String, String>();
    	headers.put("Authorization", authToken);
        
    	String bodyString = JSON.toJSONString(body);
        String respStr = httpHelper.Post(String.format("%s%s", host, String.format("/v1/mall/express")), headers, bodyString);
        
        return JSON.parseObject(respStr, V1MallExpressResponse.class);
    }
}
