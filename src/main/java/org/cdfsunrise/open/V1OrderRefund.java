...
public class V1OrderRefund {
    public static class V1OrderRefundResponse {
    ...
    */
    public V1OrderRefundResponse V1OrderRefund(String host, String authToken, OpenDataReq body) throws Exception {
