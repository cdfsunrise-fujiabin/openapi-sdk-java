...
public class V1MallDeliveryChange {
    public static class V1MallDeliveryChangeResponse {
    ...
    */
    public V1MallDeliveryChangeResponse V1MallDeliveryChange(String host, String authToken, BaseRequest body) throws Exception {
    	OkHttpHelper httpHelper = new OkHttpHelper();
    	Map<String, String> headers = new HashMap<String, String>();
    	headers.put("Authorization", authToken);
        
    	String bodyString = JSON.toJSONString(body);
        String respStr = httpHelper.Post(String.format("%s%s", host, String.format("/v1/mall/delivery/change")), headers, bodyString);
        
        return JSON.parseObject(respStr, V1MallDeliveryChangeResponse.class);
    }
}
