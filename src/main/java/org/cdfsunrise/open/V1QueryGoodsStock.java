...
public class V1QueryGoodsStock {
    public static class V1QueryGoodsStockResponse {
    ...
    */
    public V1QueryGoodsStockResponse V1QueryGoodsStock(String host, String authToken, OpenDataReq body) throws Exception {
